...
export function About() {
  return (
    <>
      ...
      <PageHero eyebrow="ABOUT JUHE" index="03" title="连接全球市场，也连接每一个增长环节。" intro="我们相信，稳定增长来自清晰的判断、专业的执行和持续透明的复盘。" image="/images/team-meeting.jpg" />
      ...
      <section className="value-section">
        <img src="/images/global-team.jpg" alt="跨市场项目协作团队" />
